...
/// クラス
/// </summary>
class MiniBossEnemy : public EnemyBase {
public:
  ...
  void SetMiniBossDeath(bool miniboss_death);


  /// <summary>
  /// 敵のx座標
  /// </summary>
  float miniboss_enemy_x_;

  /// <summary>
  /// 敵のy座標
  /// </summary>
  float miniboss_enemy_y_;

  /// <summary>
  /// 敵の速度
  /// </summary>
  float miniboss_enemy_speed_;

  /// <summary>
  /// 敵の画像のハンドル
  /// </summary>
  int miniboss_enemy_image_;

  /// <summary>
  /// 敵の幅
  /// </summary>
  int miniboss_enemy_width_;

  /// <summary>
  /// 敵の高さ
  /// </summary>
  int miniboss_enemy_height_;

  /// <summary>
  /// 画面外に出たかどうかのフラグ
  /// </summary>
  bool is_miniboss_enemy_out_of_screen_;
  ...
  /// ボス時間
  /// </summary>
  float miniboss_time_;

  /// <summary>
  /// 身にボスのy軸に対する速さ
  /// </summary>
  float miniboss_enemy_speed_y_;
};